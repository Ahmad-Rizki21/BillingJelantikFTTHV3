...
async def check_data_consistency(
    ...
    specific_checks["pelanggan_258"] = {
        "exists": pelanggan_258
    }
    ...
    langganan_with_pelanggan_258 = [
        {
            "id": l.id,
            "status": l.status,
            "paket_nama": l.paket_layanan.nama_paket if l.paket_layanan else None
        }
        for l in all_langganan if l.pelanggan_id == 258
    ]
